...
//        echo __FILE__.": ".__LINE__.'<pre>'.print_r($arrayValues, true).'</pre>';  
		...
		if ($arrayValues['ack'] !== 'Success') {
			...
			throw new FindingResponseException($arrayValues['errorMessage']['error']['message'], $arrayValues['errorMessage']['error']['errorId'], $arrayValues['errorMessage']['error']['domain'], $arrayValues['errorMessage']['error']['severity'], $arrayValues['errorMessage']['error']['category'], $arrayValues['errorMessage']['error']['subdomain']
			);
		}
		...
		if (isset($arrayValues['paginationOutput'])) {
		...
		if (isset($arrayValues['itemSearchURL'])) {
